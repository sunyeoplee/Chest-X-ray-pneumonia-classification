# title: monai bootcamp - transform
# author: Sun Yeop Lee
...
trans = Compose(
    [
        LoadNiftid(fn_keys), # apply to both image and label
        AddChanneld(fn_keys), 
...
## this makes sure that randomization is synchronized between the two keys
images = [fn["img"] for fn in filenames]
...
loader = DataLoader(ds, batch_size, num_workers=0)
